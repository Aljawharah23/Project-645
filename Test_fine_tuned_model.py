...
bug_reports = read_json_objects_as_strings('/home/aalmuhana/Desktop/replication_package/outputs/Preprocessed_Splitted_Bug-report/accumulo_preprocessed_80_data.json')
bug_report_ids = []
bug_report_texts = []
...
#  output file path
evaluation_metrics_output_file_path = '/home/aalmuhana/Desktop/replication_package/outputs/Fine_Tuned_1_EvalMatric/accumulo_FT_EvaluationMetricsOutput.txt'  
...
relevance_output_file_path = '/home/aalmuhana/Desktop/replication_package/outputs/Fine_Tuned_1_RelLists/accumulo_FT_RelevanceLists.json'  

# Save the formatted relevance lists to the output file
with open(relevance_output_file_path, 'w') as file:
    file.write(formatted_relevance_json)  

print(f"Relevance lists saved to {relevance_output_file_path}")

#  output file path
output_file_path = '/home/aalmuhana/Desktop/replication_package/outputs/Fine_Tuned_1_RankingList/accumulo_FT_Ranking_output.txt' 
